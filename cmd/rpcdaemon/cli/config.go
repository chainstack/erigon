...
func RootCommand() (*cobra.Command, *httpcfg.HttpCfg) {
	...
	rootCmd.PersistentFlags().Float64Var(&cfg.RPCTxFeeCap, utils.RPCGlobalTxFeeCapFlag.Name, utils.RPCGlobalTxFeeCapFlag.Value, utils.RPCGlobalTxFeeCapFlag.Usage)
