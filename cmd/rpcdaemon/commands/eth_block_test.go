...
func TestGetBlockByNumberWithLatestTag(t *testing.T) {
	...
	api := NewEthAPI(NewBaseApi(nil, stateCache, br, agg, false, rpccfg.DefaultEvmCallTimeout, m.Engine, m.Dirs), m.DB, nil, nil, nil, 5000000, 1.0, 100_000)
...
func TestGetBlockByNumberWithPendingTag(t *testing.T) {
	...
	api := NewEthAPI(NewBaseApi(ff, stateCache, br, agg, false, rpccfg.DefaultEvmCallTimeout, m.Engine, m.Dirs), m.DB, nil, nil, nil, 5000000, 1.0, 100_000)
